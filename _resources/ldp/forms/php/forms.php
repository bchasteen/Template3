...
$_ENV['ldp_config']['ssm_host'] = "http://209.212.159.209"; // http://127.0.0.1. SSM Host location. Change this if the SSM is on a different server than the connector script.
...
$site_uuids = array(
	 "President" => "cfd1d451-ce3a-4049-99f8-18ff62ac4edd",
	"test" => "cfd1d451-ce3a-4049-99f8-18ff62ac4edd",
);
